...
<body class="fondo">
    ...
    <div class="container mt-3 border border-2 p-3" style="border-radius: 15px; max-height: 150px; max-width: 50%; background: linear-gradient(180deg,rgb(185, 178, 178) 70%, #878c8d 100%);">
        <div class="col-md-6">
            ...
            <a href="agregarempleados.php" class="boton d-flex justify-content-center align-items-center mx-auto mt-3" style="width: 150px; height: 40px; border-radius: 10px; font-size: 1rem;">Agregar</a>
        </div>
        <div class="col-md-6">
    ...
    <script>
        function eliminar() {
            return confirm("¿Desea eliminar el empleado?")
        }
    </script>
        ...
        <div class="estilo-tabla">
            <table>
                ...
                <tbody>
                    ...
                    $sql = mysqli_query($conexion, "SELECT * FROM empleados ORDER BY ID_Empleado DESC");
