            ...
            <form method="post">
                ...
                <div class="row mb-3">
                    <div class="mb-3 col-6">
                        ...
                        <input type="datetime-local" class="form-control" name="fechaasignacion" id="fechaasignacion" required>
                    </div>
                    <div class="mb-3 col-6">
                        <label for="observaciones" class="form-label">Observaciones:</label>
                        <textarea class="form-control" name="observaciones" id="observaciones" placeholder="Observaciones..." rows="3" required></textarea>
                    </div>
                </div>
